...
#define SENSOR_SEL_ALL		(SENSOR_OUT2_SEL|SENSOR_OUT8_SEL|SENSOR_OUT11_SEL|SENSOR_OUT4)

#define SENSOR_SEL_PLUSE	(SENSOR_OUT1_SEL|SENSOR_OUT7_SEL|SENSOR_OUT10_SEL|SENSOR_OUT5)
